...
export const PROJECTS: Project[] = [
  {
    id: '1',
    name: 'Campus Career & Placement Intelligence Platform',
    problem: 'Architected a decision-support system for automated candidate-job matching based on CGPA, branch, and skill constraints. Designed REST APIs and workflow pipelines.',
    stack: ['System Architecture', 'Backend', 'REST APIs'],
    githubUrl: '#'
  },
  {
    id: '2',
    name: 'OncoAI– AI Cancer Treatment Planning',
    problem: 'Built an ML-based clinical decision support system for personalized cancer treatment using risk prediction models. Integrated SHAP-based explainability to improve trust.',
    stack: ['Machine Learning', 'SHAP', 'Healthcare AI'],
    githubUrl: '#'
  },
  {
    id: '3',
    name: 'Skills Connect Job Board',
    problem: 'Developed a full-stack job matching platform with skill- and location-based candidate filtering. Designed backend services and relational data models to manage workflow.',
    stack: ['Full-Stack', 'Database Design', 'Web Dev'],
    githubUrl: '#'
  }
];
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  {
    title: 'AI / ML & Tools',
    skills: ['scikit-learn', 'Pandas', 'NumPy', 'LangChain', 'SHAP']
  },
  {
    title: 'Core Concepts & Dev Tools',
    skills: ['Data Structures', 'Algorithms', 'OOP', 'Git', 'GitHub', 'VS Code']
  }
];
...
export const JOURNEY_ITEMS: LearningItem[] = [
  {
    ...
    status: 'Completed',
    description: 'DeepLearning.AI certification. Explored advanced machine learning techniques and fundamentals.'
  },
  {
