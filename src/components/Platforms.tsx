...
const platforms = [
  {
    ...
    colorClass: "text-[#181717] dark:text-white group-hover:text-white"
  },
  {
    name: "LinkedIn",
  ...
  },
  {
    ...
    colorClass: "text-[#2F8D46] group-hover:text-white"
  }
];
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full gap-4">
                    <div className={`p-3.5 bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 w-fit rounded-2xl group-hover:bg-primary group-hover:border-primary transition-all duration-500 group-hover:rotate-6 ${platform.colorClass}`}>
                      <Icon />
                    </div>
